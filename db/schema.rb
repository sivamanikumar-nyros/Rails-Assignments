...
ActiveRecord::Schema.define(version: 2018_12_04_033935) do
  ...
  create_table "stories_writers", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
